...
!(function () {
  ...
  var n = tinymce.util.Tools.resolve('tinymce.PluginManager'),
    t = function (n, e) {
      var o,
        t =
          (o = n).plugins.visualchars && o.plugins.visualchars.isEnabled()
            ? '<span class="mce-nbsp">&nbsp;</span>'
            : '&nbsp;'
      n.insertContent(
        (function (n, e) {
          for (var o = '', t = 0; t < e; t++) o += n
          return o
        })(t, e)
      ),
    ...
    o = function (e) {
      ...
      0 < o &&
        e.on('keydown', function (n) {
          if (n.keyCode === i.TAB && !n.isDefaultPrevented()) {
            if (n.shiftKey) return
            n.preventDefault(), n.stopImmediatePropagation(), t(e, o)
          }
        })
    },
    r = function (n) {
