...
!(function (o) {
  ...
  var a = function (t) {
    ...
    i = tinymce.util.Tools.resolve('tinymce.util.LocalStorage'),
    ...
    f = function (t) {
      ...
      )).replace(/\{query\}/g, o.document.location.search)).replace(
        /\{hash\}/g,
    ...
    c = function (t, e) {
      ...
      return (
        '' === (e = u.trim(void 0 === e ? t.getBody().innerHTML : e)) ||
        new RegExp(
          '^<' +
            r +
            '[^>]*>((\xa0|&nbsp;|[ \t]|<br[^>]*>)+?|)</' +
    ...
    l = function (t) {
      var e = parseInt(i.getItem(f(t) + 'time'), 10) || 0
      return !(
        new Date().getTime() - e > s(t.settings.autosave_retention, '20m') &&
        (m(t, !1), 1)
      )
    },
    m = function (t, e) {
      var r = f(t)
      i.removeItem(r + 'draft'),
        i.removeItem(r + 'time'),
    ...
    v = function (t) {
      ...
      !c(t) &&
        t.isDirty() &&
        (i.setItem(e + 'draft', t.getContent({ format: 'raw', no_events: !0 })),
        i.setItem(e + 'time', new Date().getTime().toString()),
        t.fire('StoreDraft'))
    },
    d = function (t) {
      var e = f(t)
      l(t) &&
        (t.setContent(i.getItem(e + 'draft'), { format: 'raw' }),
        t.fire('RestoreDraft'))
    },
    g = function (t, e) {
      var r = s(t.settings.autosave_interval, '30s')
      e.get() ||
  ...
  D._beforeUnloadHandler = function () {
    var e
    return (
      u.each(D.get(), function (t) {
  ...
  t.add('autosave', function (t) {
    var e,
      ...
      n = a(!1)
    return (
      (o.window.onbeforeunload = D._beforeUnloadHandler),
      g((e = t), n),
