...
!(function (t) {
  ...
  var a = function (e) {
    ...
    h = tinymce.util.Tools.resolve('tinymce.util.URI'),
            ...
            p.send({
              ...
              success: function (e) {
                if ((e = JSON.parse(e))) e.error ? r(e.error) : n(e)
                  ...
                  var t = c.translate("Server response wasn't proper JSON.")
                  r(t)
                }
              },
              error: function () {
    ...
    E =
      ...
      function () {
        ...
        for (var n = {}, r = 0; r < e.length; r++) {
          var o = e[r]
          for (var i in o) B.call(o, i) && (n[i] = m(n[i], o[i]))
        }
        return n
      }),
    C = 'SpellcheckStart SpellcheckEnd',
      ...
      h.ui.registry.addContextMenu('spellchecker', {
        update: function (e) {
          ...
          var n,
            ...
            u,
            d,
            f = T.findSpansByIndex(h, T.getElmIndex(t))
          if (0 < f.length) {
            ...
            return (
              ...
              N.each(d, function (e) {
                u.push({
                  text: e,
                  onAction: function () {
                    n.insertContent(n.dom.encode(e)),
                      n.dom.remove(l),
                      T.checkIfFinished(n, i, a)
                  },
                })
              }),
              o.get().hasDictionarySupport &&
                ...
                u.push({
                  ...
                  onAction: function () {
                    T.addToDictionary(n, r, i, a, c, s, l)
                  },
                })),
              u.push.apply(u, [
                { type: 'separator' },
                {
                  text: 'Ignore',
                  onAction: function () {
                    T.ignoreWord(n, i, a, s, l)
                  },
                },
                {
                  text: 'Ignore all',
                  onAction: function () {
                    T.ignoreWord(n, i, a, s, l, !0)
                  },
                },
              ]),
              u
