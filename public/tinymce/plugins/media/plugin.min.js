...
!(function () {
  ...
  var a,
    ...
    b =
      ...
      function () {
        ...
        for (var r = {}, n = 0; n < e.length; n++) {
          var i = e[n]
          for (var o in i) u.call(i, o) && (r[o] = a(r[o], i[o]))
        }
        return r
      }),
    s = function (e) {
    ...
    W = {
      getMaxWidth: U('maxWidth'),
      getMaxHeight: U('maxHeight'),
      setMaxWidth: R('maxWidth'),
      setMaxHeight: R('maxHeight'),
    },
    H = N.DOM,
    L = function (e) {
      return H.getAttrib(e, 'data-ephox-embed-iri')
    },
    I = function (e, t) {
      return (
        (c = t),
        (u = H.createFragment(c)),
        '' !== L(u.firstChild)
          ? ((o = t),
            (a = H.createFragment(o).firstChild),
            {
              type: 'ephox-embed-iri',
              source1: L(a),
              source2: '',
              poster: '',
              width: W.getMaxWidth(a),
              height: W.getMaxHeight(a),
            })
          : ((n = e),
            (r = t),
            D({
              ...
              start: function (e, t) {
                if (
                  ...
                  ('iframe' !== e &&
                    ...
                    'video' !== e &&
                    'audio' !== e) ||
                    (i.type || (i.type = e), (i = _.extend(t.map, i))),
                  'script' === e)
                ) {
                  var r = E(n, t.map.src)
                  if (!r) return
    ...
    G = tinymce.util.Tools.resolve('tinymce.html.Writer'),
    ...
    V = function (e, t) {
      var r,
        n,
        i = K.createFragment(e).firstChild
      return (
        W.setMaxWidth(i, t.width),
        W.setMaxHeight(i, t.height),
        (r = i.outerHTML),
        (n = G()),
        D(n).parse(r),
        n.getContent()
    ...
    X = function (e, t, r) {
      return (
        (s = e),
        (l = K.createFragment(s)),
        '' !== K.getAttrib(l.firstChild, 'data-ephox-embed-iri')
          ? V(e, t)
          : ((n = e),
            (i = t),
            (o = r),
                ...
                start: function (e, t, r) {
                  switch (e) {
                    ...
                    case 'iframe':
                      i.height !== undefined &&
                        i.width !== undefined &&
                        Q(t, { width: i.width, height: i.height })
                  }
                  if (o)
                    switch (e) {
                      case 'video':
                        Q(t, { poster: i.poster, src: '' }),
                          i.source2 && Q(t, { src: '' })
                        break
                      case 'iframe':
                        Q(t, { src: i.source1 })
                  ...
                  if (i.poster && 'object' === e && o && !a) {
                    var n = []
                    ;(n.map = {}),
                      Q(n, { src: i.poster, width: i.width, height: i.height }),
                      c.start('img', n, !0)
                  }
                  c.end(e)
                },
    ...
    Z = function (r, e) {
      var n = _.extend({}, e)
      if (!n.source1 && (_.extend(n, I(C(r), n.embed)), !n.source1)) return ''
      n.source2 || (n.source2 = ''),
        n.poster || (n.poster = ''),
        (n.source1 = r.convertURL(n.source1, 'source')),
        (n.source2 = r.convertURL(n.source2, 'source')),
        (n.source1mime = B(n.source1)),
        (n.source2mime = B(n.source2)),
      ...
      if (
        ...
        return X(n.embed, n, !0)
      var a = E(C(r), n.source1)
      ...
      return c
        ? ((i = t),
          ...
          new q(function (t, e) {
            var r = function (e) {
              return (
                e.html && (ee[i.source1] = e),
                t({ url: i.source1, html: e.html ? e.html : o(i) })
              )
            }
            ee[i.source1] ? r(ee[i.source1]) : a({ url: i.source1 }, r, e)
          }))
        : ((r = t),
          (n = te(e)),
          new q(function (e) {
    ...
    oe = function (e) {
      return b(e, {
        source1: { value: j(e, 'source1').getOr('') },
        source2: { value: j(e, 'source2').getOr('') },
    ...
    se = function (a) {
      var e,
        ...
        i,
        o =
          ((t = (e = a).selection.getNode()),
          (r = t.getAttribute('data-ephox-embed-iri'))
            ? { source1: r, width: W.getMaxWidth(t), height: W.getMaxHeight(t) }
            : t.getAttribute('data-mce-object')
            ? I(C(e), e.serializer.serialize(t, { selection: !0 }))
            : {}),
        c = {
          source1: '',
          source2: '',
          embed:
            ...
            i.getAttribute('data-ephox-embed-iri')
              ? n.selection.getContent()
              : ''),
          poster: '',
          dimensions: {
        ...
        s = function (e) {
          var t = ie(e.getData())
          return z(a)
            ? b(t, { width: t.dimensions.width, height: t.dimensions.height })
            : t
        },
        l = function (e) {
          var r,
          ...
          re(a, t)
            .then(
              ...
              (o = a),
              function (e) {
                if (v(e.url) && 0 < e.url.trim().length) {
                  var t = e.html,
                    n = ce(o, t),
                    i = { source1: e.url, embed: t }
                  !(function (e, t) {
                    for (var r = 0, n = e.length; r < n; r++) t(e[r], r, e)
                  })(['width', 'height'], function (r) {
                    j(n, r).each(function (e) {
                      var t = i.dimensions || {}
                      ;(t[r] = e), (i.dimensions = t)
                    })
                  }),
                    r.setData(oe(i))
                }
      ...
      var f = { title: 'Advanced', items: h },
        p = [m, d]
      0 < h.length && p.push(f)
      var g = { type: 'tabpanel', tabs: p },
        w = a.windowManager.open({
          ...
          onSubmit: function (e) {
            var t,
              ...
              n = s(e)
            ;(r = a),
              ((t = n).embed = X(t.embed, t)),
              t.embed && ne(t.source1)
                ? ue(r, t.embed)
                : re(r, t)
                    .then(function (e) {
                      ue(r, e.html)
          ...
          onChange: function (e, t) {
            switch (t.name) {
              ...
              case 'embed':
                ;(n = ie((r = e).getData())),
                  ((i = ce(a, n.embed)).dimensions = {
                    width: i.width ? i.width : n.dimensions.width,
                    height: i.height ? i.height : n.dimensions.height,
                  }),
                  r.setData(oe(i))
            }
            var r, n, i
    ...
    we = function (e, t, r) {
      ...
      ;(c = t.firstChild && t.firstChild.value) &&
        (r.attr('data-mce-html', escape(fe(e, c))), (r.firstChild = null))
    },
    ve = function (e) {
      for (; (e = e.parent); )
        if (
        ...
        for (var t, r, n = e.length; n--; )
          (t = e[n]).parent &&
            (t.parent.attr('data-mce-object') ||
              (('script' !== t.name || (r = E(C(i), t.attr('src')))) &&
                (r &&
                  (r.width && t.attr('width', r.width.toString()),
                  r.height && t.attr('height', r.height.toString())),
                'iframe' === t.name && P(i) && he.ceFalse
                  ? ve(t) || t.replace(ge(i, t))
      ...
      t.on('click keyup', function () {
        ...
        t.on('objectResized', function (e) {
          ...
          r.getAttribute('data-mce-object') &&
            ...
            r.setAttribute(
              'data-mce-html',
              escape(X(t, { width: e.width, height: e.height }))
            ))
        })
    },
    Oe = function (e) {
  ...
  i.add('media', function (e) {
    return me(e), Oe(e), xe(e), ye(e), je(e), le(e)
  }),
    function Ae() {}
})()
