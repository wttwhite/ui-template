  ...
  var e,
    ...
    O = function (e, t, n) {
      ...
      return (
        ...
        (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t =
          ...
          '%y',
          '' + n.getYear()
        )).replace('%m', b(n.getMonth() + 1, 2))).replace(
          '%d',
          b(n.getDate(), 2)
        )).replace('%H', '' + b(n.getHours(), 2))).replace(
          '%M',
          '' + b(n.getMinutes(), 2)
        )).replace('%S', '' + b(n.getSeconds(), 2))).replace(
          '%I',
          '' + (((n.getHours() + 11) % 12) + 1)
    ...
    A = function (t, e, n) {
      ...
      ;(n = T(n, g(t))),
        ...
        p.each(o.select('*', r), function (e) {
          _(e, l(t).replace(/\s+/g, '|')) && (e.innerHTML = O(t, h(t))),
            _(e, s(t).replace(/\s+/g, '|')) && (e.innerHTML = O(t, v(t))),
            _(e, f(t).replace(/\s+/g, '|')) && (e.innerHTML = u)
        }),
        M(t, r),
    ...
    E = function (e) {
      return e.replace(/["'<>&]/g, function (e) {
        return ((t = F), (n = e), q(t, n) ? J.from(t[n]) : J.none()).getOr(e)
        var t, n
      })
    },
    R = function (l, t) {
            ...
            var r = (function (t, e) {
              ...
              a = [
                ...
                },
                {
                  type: 'htmlpanel',
                  html:
                    '<p aria-live="polite">' + E(t.value.description) + '</p>',
                },
                {
                  label: 'Preview',
                  type: 'iframe',
