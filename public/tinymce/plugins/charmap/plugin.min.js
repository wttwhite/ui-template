...
!(function (l) {
  ...
  var e,
    ...
    o = function (e, n) {
      return e.fire('insertCustomChar', { chr: n })
    },
    f = function (e, n) {
      var r = o(e, n).chr
    ...
    T = function (e) {
      var n = (function (e, n) {
        ...
        if (t) {
          ...
          return a.length
            ? ((a[0].characters = [].concat(a[0].characters).concat(S(t))), n)
            : [].concat(n).concat({ name: q, characters: S(t) })
        }
        return n
      })(e, [
        {
      ...
      return (
        (function (e, n) {
          ...
          ;(n = e[0]),
            (r = e[1]),
            (t = i),
            (U(String.fromCharCode(n).toLowerCase(), t) ||
              U(r.toLowerCase(), t) ||
              U(r.toLowerCase().replace(/\s+/g, ''), t)) &&
              a.push(e)
        }),
        C(a, function (e) {
          return {
            text: e[1],
            value: String.fromCharCode(e[0]),
            icon: String.fromCharCode(e[0]),
          }
        })
      )
    },
          ...
          body:
            1 === e.length
              ...
              : {
                  type: 'tabpanel',
                  tabs: C(e, function (e) {
                    return { title: e.name, items: n() }
                  }),
                },
          buttons: [
            { type: 'cancel', name: 'close', text: 'Close', primary: !0 },
          ],
          initialData: { pattern: '', results: D(e[0], '') },
