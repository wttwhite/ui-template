...
!(function (y) {
  ...
  var Ue,
    ...
    Tt = function (n) {
      return ((e = n), '' === e ? _.none() : _.some(e.substr(0, 1)))
        .bind(function (t) {
          return ((e = n), '' === e ? _.none() : _.some(e.substring(1))).map(
            function (e) {
    ...
    Mt =
      (y.Node.ATTRIBUTE_NODE, y.Node.CDATA_SECTION_NODE, y.Node.COMMENT_NODE),
    Rt = y.Node.DOCUMENT_NODE,
    Ft =
      (y.Node.DOCUMENT_TYPE_NODE,
          ...
          e
            ...
            : ((n = hn),
              ...
              dn.each(d.split(';'), function (e) {
                var t = e.indexOf(':')
                0 < t &&
                  ((l = dn.trim(e.substring(0, t))).toUpperCase() === l &&
                    (l = l.toLowerCase()),
            ...
            dn.each(u, function (e, t) {
              ...
              null === n
                ? (i.style.removeProperty
                    ? i.style.removeProperty(En(t))
                    : i.style.removeAttribute(En(t)),
                  delete u[t])
                : ((o += t + ': ' + n + '; '), (u[t] = n))
            }),
              (o = o || null),
      ...
      return {
        ...
        next: function () {
          ...
          return (
            ...
            n === Cn.FINISHED ||
              a ||
              (o.body.removeChild(i), (a = Cn.FINISHED)),
            (t = r),
    ...
    Rn = An(function (e, t) {
      var n,
        r = function () {
          Mn ||
            (e.emit(Cn.createStartElement('P', {}, {}, e.document)), (Mn = !0))
        }
      switch (t.type()) {
        case Cn.TEXT_TYPE:
          r(), e.emit(t)
        ...
        (e.inferring
          ...
          : ('OL' === t.tag() || 'UL' === t.tag()
              ...
              : 'LI' === t.tag() &&
                ((e.inferring = 1),
                e.needsClosing ||
                  e.emit(Cn.createStartElement('UL', {}, {}, e.document))),
            !e.needsClosing ||
              e.inferring ||
              t.isWhitespace() ||
              ((e.needsClosing = !1),
    ...
    tr = function (e, t) {
      if ((Zn.push(t), (Jn = Jn || []), t.type() === Cn.START_ELEMENT_TYPE))
        Jn.push(t)
    ...
    Ir =
      ...
      function (e, t) {
        var n,
          r = e + ',' + t
        return Be.hasOwnProperty(r)
          ? Be[r]
          : ((n = Ue.call(null, e, t)), (Be[r] = n))
      }),
    Sr = function (e, t) {
      var n,
        r,
    ...
    return {
      ...
      openItem: function (e, t, n, r) {
        if (n) {
          ...
          if (
            ((i = e),
            'UL' === (o = n).tag && Nr[i - 1] === o.type && (o = { tag: 'UL' }),
            (n = o),
            s === e)
          )
            d(), m(t, n, r)
            ...
            for (
              ...
              0 < c.length &&
              'P' !== c[c.length - 1] &&
              (a.emit(Cn.createEndElement(c[c.length - 1], u)),
              (c[c.length - 1] = 'P'));
              s < e;
  ...
  var Or = function (e, t) {
    ...
    Pr = function (e, t, n) {
      ...
      if (n.type() === Cn.START_ELEMENT_TYPE && Kn(n) && 'LI' !== n.tag()) {
        ...
        !Gn &&
        ((n.type() === Cn.COMMENT_TYPE && '[if !supportLists]' === n.text()) ||
          Sr(n, e))
          ? (n.type() === Cn.START_ELEMENT_TYPE &&
              'SPAN' === n.tag() &&
              t.spanCount.push(n),
    ...
    Rr = function (e, t, n) {
      n.type() === Cn.TEXT_TYPE
        ...
        ? ((t.nextFilter = Fr),
          (t.bulletInfo = { text: '\u2202', symbolFont: !0 }))
        : Or(e, n)
    },
    Fr = function (e, t, n) {
    ...
    jr = function (e, t, n) {
      n.type() === Cn.END_ELEMENT_TYPE &&
        (zn(n) && t.spanCount.pop(), (t.nextFilter = Ur))
    },
    Ur = function (o, i, a) {
      var e = function (e) {
        var t, n, r
  ...
  var qr = [
      ...
      An(
        function (e, t) {
          Hr.styles.check(t) ||
            ((Hr.symbolFont = Er.checkFont(t, Hr.symbolFont)),
    ...
    var f = function (e, t) {
      ...
      m = function (e) {
        an.multiple(e).get(function (e) {
          ...
          u.insertContent(t, { merge: !1 !== u.settings.paste_merge_formats }),
            r.uploadImages(e)
        })
      }
    u.on('drop', function (e) {
      if (!s) {
        ...
        d((o = r)) ||
          ...
          (Zr(u, ln.translate, c).showDialog(r['text/html'] || r['text/plain']),
          e.preventDefault())
      }
      var o, i, a
    })
      ...
      return (
        ...
        function (t) {
          ...
          0 < e.length &&
            (function (e) {
              throw new Error(
                'Unsupported keys for object: ' + eo(e).join(', ')
              )
            })(e)
          var r = {}
          return (
  ...
  var ao = {
    ...
    To = function (e) {
      return (
        (e.nodeType !== yo && e.nodeType !== bo) || 0 === e.childElementCount
      )
    },
    Eo = function (e, t) {
  ...
  var Yo = ue([{ get: [] }, { post: [] }, { put: [] }, { del: [] }]),
    ...
    si = function (i, a, u, c, s, e) {
      ...
      return ii(function (t) {
        ...
        ;(n.onload = function () {
          0 !== n.status || Et(i, 'file:')
            ? n.status < 100 || 400 <= n.status
              ? o()
              : ci(c, n).get(t)
            : o()
        }),
        ...
        '' !== o.protocol
          ...
          : ('' !== o.authority
              ...
              : ('' === o.path
                  ...
                  : (Et(o.path, '/')
                      ? (i.path = Ii(o.path))
                      : ((i.path = Si(r.path, o.path, e.authority)),
                        (i.path = Ii(i.path))),
                    (i.query = o.query)),
        ...
        si(n, u, _.some(r), o, i, a)).map(function (e) {
          e.fold(
            function (e) {
              l(
                Go.error(
                  yi.failureObject(e.message(), e.status(), e.responseText())
                )
              )
            },
            function (t) {
  ...
  var Di = function (e) {
    ...
    Ji = function (e, t, n) {
      var r = e.isActive(t)
      return (
        e.register(n, t), Mi(n, go.uploadInProgress()), r ? _.none() : _.some(t)
      )
    },
    Qi = function (e, n, a, r, u, t, c) {
      var s = function () {
        y.console.error('Internal error with blob cache', u),
          c(zi.failure({ status: v(666) }))
      }
    ...
    ya = function (r, e) {
      var o,
        ...
        l =
          ...
          (a = function () {
            return (
              ln.translate('error.code.images.not.found') +
              t +
              ln.translate('error.full.stop')
            )
          }),
          (u = function () {
            return (
              ln.translate('error.imageupload') +
              t +
              ln.translate('error.full.stop')
            )
          }),
  ...
  var Ta = function (t, r, e, n) {
      ...
      if (!l.get('_mcePaste')) {
        if (
          ...
          (u =
            f !== t.getDoc().body
              ? l.getPos(t.selection.getStart(), f).y
              : f.scrollTop),
          l.setStyles(o, {
            position: 'absolute',
            left: -1e4,
      ...
      return {
        ...
        next: function () {
          ...
          return (
            ...
            n === Lu.FINISHED ||
              a ||
              (o.body.removeChild(i), (a = Lu.FINISHED)),
            (t = r),
  ...
  function Uu(a, u, e) {
    return function (t, e, n) {
      var r = function (e) {
        ...
        o = function (e, t, n) {
          return (
            (n = void 0 !== n ? n : e.type() === Lu.END_ELEMENT_TYPE),
            Lu.token(t, n, {})
          )
        },
        i = {
  ...
  var Bu = function (e, t) {
    ...
    Ku = function (e, n, t, r) {
      ...
      return qu.guessFrom(r.emblems(), i).filter(function (e) {
        return !(
          'OL' === e.tag &&
          (!Y(['P'], (t = n).tag()) || /^MsoHeading/.test(Bu(t, 'class')))
        )
        var t
      })
    },
  ...
  var nc,
    ...
    Jc = function (e, t) {
      ...
      n.acceptNode = n
      var r = y.document.createTreeWalker(
        e.dom(),
        we.getOrDie('NodeFilter').SHOW_COMMENT,
        n,
        !1
      )
      return Kc(r)
  ...
  var as,
    ...
    hs = function (e) {
      return Do(e).bind(function (e) {
        return qt(e) && 0 === ps(e).trim().length
          ? hs(e)
          : 'li' === Ut(e)
          ? _.some(e)
          : _.none()
    ...
    ys = {
      ...
      fontToSpan: function (e) {
        ...
        ne(
          { face: 'font-family', size: 'font-size', color: 'color' },
          function (e, t) {
            if (zt(o, t)) {
              var n = Gt(o, t),
    ...
    Ls = Pu({
      ...
      styles: [
        { name: tu.all(), value: tu.pattern(/OLE_LINK/i, tu.caseInsensitive) },
      ],
    }),
    ...
    Ds = Pu({
      styles: [
        {
          name: tu.not(
            tu.pattern(/width|height|list-style-type/, tu.caseInsensitive)
          ),
    ...
    Us = Mu({
      tags: [{ name: tu.exact('p', tu.caseInsensitive), mutate: ys.addBrTag }],
    }),
    Bs = Mu({
      tags: [
        {
          ...
          tags: [
            {
              ...
              mutate: function (e) {
                '\xa0' === qc(e) &&
                  (ss(e) || ls(e) ? ja(e) : (ua(e, cn.fromText(' ')), Fa(e)))
              },
            },
          ],
        })),
          ...
          n.each(function (e) {
            for (
              var t,
                ...
                r = [],
                o =
                  ((t = bs(i, 0, e, 0)), cn.fromDom(t.commonAncestorContainer));
              void 0 !== o && !Io(o, a);
    ...
    Xs = function (e, t, n) {
      ...
      return Z([
        ...
        ((m = t),
        m
          ? [qs.mergeStyles, qs.mergeClasses]
          : [qs.cleanStyles, qs.cleanClasses]),
        [
          qs.distillAnchorsFromLocalLinks,
          qs.removeLocalLinks,
          qs.removeVacantLinks,
          qs.replaceClipboardChangedUrls,
        ],
        [qs.removeEmptyStyle],
        [qs.removeEmptyClass],
        [qs.pruneInlineTags],
        ...
        ((s = e),
        (l = n),
        $s(l) && s ? [qs.unwrapSingleParagraphsInlists] : []),
        [qs.cleanupFlags],
        [qs.removeStyleTags],
      ])
    },
          ...
          match: function (t, n) {
            ...
            return Pa(r, function (e) {
              ...
              'Must find branch for constructor: ' +
                (0 === (e = t._simpleAdt).indexOf(Al)
                  ? e.substring(Al.length + '_'.length)
                  : e)
            )(t.data)
          },
        })
        ...
        return {
          ...
          getText: function () {
            return Xl(e).fold(function () {
              ...
              return void 0 !== e
                ? _.some(Fl.constructors.text({ text: e.getData('text') }))
                : _.none()
            }, r)
          },
          getHtml: function () {
    ...
    gf = function (e, t) {
      ...
      return (r = (n = i).ltr()).collapsed
        ? n
            ...
            .map(function (e) {
              return mf.rtl(
                cn.fromDom(e.endContainer),
                e.endOffset,
                cn.fromDom(e.startContainer),
                e.startOffset
              )
            })
            .getOrThunk(function () {
  ...
  var jf = function (e, t) {
      ...
      return Ie(
        [
          Le(
            (function (e) {
              for (
                var t = new Array(e.length / 2), n = 0;
                n < e.length;
                n += 2
              ) {
                var r = e.substr(n, 2)
    ...
    Kf = function (e, t) {
      ...
      return n && n[1] && n[1].length % 2 == 0
        ? Go.value(n[1])
        : Go.error('errors.imageimport.invalid')
    },
    Zf = function (e) {
        ...
        return {
          handle: function (e, t) {
            return n.proxyBin().fold(function () {
              return (
                y.console.error(e),
                _a.pure({ response: Na.cancel(), bundle: Sa.nu({}) })
              )
            }, t)
          },
        }
    ...
    hd = function (r, o) {
      return function (e, t) {
        var n = function (e) {
          return _a.pure({
            response: t.response(),
            bundle: Sa.nu({ officeStyles: e, htmlStyles: e }),
          })
        }
        return sd.isInternal(t.bundle())
          ? n(!0)
          : sd.isGoogleDocs(t.bundle())
          ? n(!1)
          : gd(r, o)(e, t)
      }
    },
    ...
    wd = function (e) {
      return (function (e) {
        ...
        try {
          ...
          return (
            y.console.log('Error reading iframe: ', t),
  ...
  var Ad = Od.exports.boltExport,
      ...
      if (
        ...
        q(n, function (e) {
          var t,
            ...
            c =
              ((i = u),
              (a = zt((o = l), 'data-tab-interval')
                ? Gt(o, 'data-tab-interval')
                : '36pt'),
              i.convertToPx(a)),
            s = Yd(e, c, u).getOr({})
    ...
    Yd = function (f, d, m) {
      var p = function (e) {
        return zt(e, 'data-list-level')
          ? parseInt(Gt(e, 'data-list-level'), 10)
          : 1
      }
      return Va(f, 'text-indent').bind(function (l) {
        return Va(f, 'margin-left').map(function (e) {
          var t = Va(f, 'list-style').exists(function (e) {
            ...
            n = zt(f, 'data-border-margin')
              ? Gt(f, 'data-border-margin')
              : '0px',
            r = t ? p(f) + 1 : p(f),
            o = m.convertToPx(e) + m.convertToPx(n),
            i = d * r,
            a = zt(f, 'data-text-indent-alt')
              ? m.convertToPx(Gt(f, 'data-text-indent-alt'))
              : m.convertToPx(l),
            u = {},
            c = (d / 2) * -1 - a
        ...
        t.cleanDocument(n, c).get(function (e) {
          e.fold(
            ...
            function (e) {
              ...
              null == (o = e) || 0 === o.length
                ? ((r = i),
                  _a.call(r, { response: Na.paste([], []), bundle: Sa.nu({}) }))
                : ((t = i),
                  (n = e),
                  (a = s),
                  (u = function (e) {
    ...
    um = function () {
      return function (e, t) {
        var n = Fl.asImages(e).getOrDie(
          'Must have image data for images handler'
        )
        return $d(n.images())
      }
    },
    ...
    fm = function (o, i) {
      return function (e, t) {
        var n = Fl.asWord(e).getOrDie(
            'Wrong input type for Word Import handler'
          ),
    ...
    return function (e, t) {
      ...
      return _a.sync(function (u) {
        ...
        e.events.after.bind(function (e) {
          ...
          if (
            bm.browser.isSafari() &&
            Vi(t, 'img[src^="webkit-fake-url"]').isSome()
          ) {
    ...
    Dm = {
        ...
        return Nm(
          ...
          [
            ...
            Nf(
              ...
              function (t, r) {
                var e = Fl.asWord(t).getOrDie(
                    'Word input required for rtf data'
                  ),
                  n = function (o) {
                ...
                return kl.match(e.rtf(), {
                  ...
                  fromClipboard: function (e) {
                    return n(
                      !0 === o.allowLocalImages ? _.some(e.rtf()) : _.none()
                    )
                  },
                })
              })
      ...
      googledocs: function (e, t, n) {
        return Nm(
          ...
          Cm,
          [
            Df(dm({ officeStyles: !1, htmlStyles: !1 })),
            Df(sm(t, n)),
            Df(Ff(e)),
            Df(Cf()),
          ],
      ...
      image: function (e) {
        return Nm(
          'Image pasting',
          wm,
          [Df(!1 === e.allowLocalImages ? am() : um()), Df(Cf())],
          !0
        )
      },
  ...
  var km = Om('ephox.flash'),
    ...
    jm = function (e) {
      ...
      var n = At.detect().os.isOSX() ? ['\u2318'] : ['Ctrl'],
        r = cn.fromHtml(
          '<p>' + e('cement.dialog.flash.trigger-paste') + '</p>'
        ),
        o = cn.fromHtml(
    ...
    return {
      open: function () {
        var e = (function (r) {
              ...
              setPasteCallback: km.permanent(function (e) {
                o.stop(),
                  y.setTimeout(function () {
                    '' === e
                      ? t.trigger.error('flash.crashed')
                      : t.trigger.response(unescape(e))
                  }, 0)
              }),
          ...
          la(n, l)
          var m = function () {
              Mm.browser.isFirefox() &&
                y.window.getSelection().removeAllRanges(),
                Am(l)
            },
            p = null,
            g = function () {
          ...
          }),
          {
            ...
            toOn: function (i, e) {
              ...
              o.each(function (e) {
                var t = ko(i),
                  n =
                    Io(i, e.startContainer()) && t < e.startOffset()
                      ? t
                      : e.startOffset,
                  r =
                    Io(i, e.endContainer()) && t < e.endOffset()
                      ? t
                      : e.endOffset,
  ...
  var xp = 'powerpaste-styles',
    ...
    Np = function (e, t, n, r) {
      Cp(e.clipboardData, t.html, t.text)
        ? (e.preventDefault(), r())
        : n(t.html, r)
    },
    Dp = function (a) {
    ...
    Op = function (e) {
      var t = Sp.retainContentEditable(
        e.selection.getContent({ contextual: !0 })
      )
      return {
        html: Sp.mark(t),
    ...
    _p = {
      ...
      restoreStyleAttrs: function (e) {
        q(W(e.getElementsByTagName('*'), cn.fromDom), function (e) {
          zt(e, 'data-mce-style') &&
            !zt(e, 'style') &&
            Vt(e, 'style', Gt(e, 'data-mce-style'))
        })
      },
    },
    Pp = {
      showDialog: function (e, t) {
        var n = {
          ...
          body: {
            type: 'panel',
            items: [{ type: 'htmlpanel', name: 'errorpanel', html: t }],
          },
          initialData: {},
      ...
      process: function (e, t, n) {
        ...
        return (
          ...
          (o = Wp((f = r = e), 'PastePreProcess')
            ? ((p = d),
              (g = m),
              f.fire('PastePreProcess', { internal: g, content: p }).content)
            : d),
          (i = n),
          Wp(r, 'PastePostProcess')
            ? ((u = o),
              ...
              (l = a.fire('PastePostProcess', { internal: c, node: s }).node
                .innerHTML),
              a.dom.remove(s),
              l)
            : o
        ...
        var r,
          o =
            !1 !== e.settings.smart_paste
              ? [Hp.linkSelection, Hp.insertImage]
              : []
        Hp.until(
          e,
          t,
      ...
      var s,
        ...
        m =
          ...
          Ef(
            [
              Dm.onlyText(),
              Dm.wordimport(i, n, o, u),
              Dm.googledocs(o, r, t),
              Dm.nativeHtml(n, o, r, t),
              Dm.image(o),
            ],
          ...
          var t,
            ...
            o = (function (t, n) {
              ...
              var i = function () {
                var e = !r.get()
                r.set(e),
                  t.fire('PastePlainTextToggle', { state: e }),
                  t.focus()
              }
              return {
