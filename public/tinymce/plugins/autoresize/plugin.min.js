  ...
  var i = function (e) {
    ...
    p = function (e, t) {
      var n,
        ...
        u = e.getDoc()
      if (u)
        if ((a = e).plugins.fullscreen && a.plugins.fullscreen.isFullscreen())
          v(e, !0)
        else {
          var a,
            s = u.body
          i = d(e)
          var c = y(r, s, 'margin-top', !0),
            f = y(r, s, 'margin-bottom', !0)
          ;(o = s.offsetHeight + c + f) < 0 && (o = 0)
          var g =
            e.getContainer().offsetHeight -
            e.getContentAreaContainer().offsetHeight
          o + g > d(e) && (i = o + g)
          var l = h(e)
          l && l < i ? ((i = l), v(e, !0)) : v(e, !1),
            i !== t.get() &&
              ((n = i - t.get()),
