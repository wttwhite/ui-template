...
!(function (t) {
  ...
  var e,
        ...
        : ((o = n),
          ...
          (t = e).undoManager.transact(function () {
            ...
            t.insertContent(
              ...
              (e = t.dom.select('*[data-mce-id]')[0]).removeAttribute(
                'data-mce-id'
              ),
    ...
    c = 'undefined' != typeof t.window ? t.window : Function('return this;')(),
    f = function (e, n) {
      return (function (e, n) {
        for (
          var r = n !== undefined && null !== n ? n : c, t = 0;
          t < e.length && r !== undefined && null !== r;
          ++t
        )
          r = r[e[t]]
        return r
    ...
    S = {
      ...
      none: w,
      from: function (e) {
        return null === e || e === undefined ? E : T(e)
      },
    },
    x = function (e) {
    ...
    y = {
      ...
      fromPoint: function (e, n, r) {
        var t = e.dom()
        return S.from(t.elementFromPoint(n, r)).map(x)
      },
    },
    k =
  ...
  function q(e, n, r, t, o) {
    return e(r, t) ? S.some(r) : I(o) && o(r) ? S.none() : n(r, t, o)
  }
  ...
  var L,
    ...
    de =
      ...
      function () {
        ...
        return P || ((P = !0), (F = L.apply(null, e))), F
      }),
    le = k,
    me = function (e, n) {
      var r = e.dom()
    ...
    ge =
      (de().browser.isIE(),
      function (e, n, r) {
        for (var t = e.dom(), o = I(r) ? r : v(!1); t.parentNode; ) {
          t = t.parentNode
          var i = y.fromDom(t)
          if (n(i)) return S.some(i)
          if (o(i)) break
        }
        return S.none()
      }),
        ...
        function (e, n, r) {
          return (
            ...
            (function (e, n) {
              ...
              return M(e) ? n : R(e) ? (!1 === e ? '' : n) : e
            })(e.getParam(n, r), r)
          )
        }),
    },
    pe = function (e) {
      return ve.getToolbarItemsOr(
        e,
      ...
      0 < e.trim().length &&
        a.ui.registry.addContextToolbar('quickblock', {
          predicate: function (e) {
            ...
            return ((n = o), (r = 'table'), (t = u), q(me, he, n, r, t)).fold(
              function () {
                return ((e = o),
                (n = function (e) {
                  return (
                    e.dom().nodeName.toLowerCase() in i &&
                    a.dom.isEmpty(e.dom())
                  )
                }),
                (r = u),
